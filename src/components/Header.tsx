...
function useTypingEffect(text: string, speed: number = 100, delay: number = 1000) {
  ...
  return (
    ...
    >
      <nav className="container mx-auto px-6 py-4">
        ...
        {isMobileMenuOpen && (
          <div className={`md:hidden mt-4 py-4 space-y-4 backdrop-blur-sm rounded-lg shadow-xl ${
            darkMode
              ? 'bg-gray-900/95'
              : 'bg-white/95'
          }`}>
