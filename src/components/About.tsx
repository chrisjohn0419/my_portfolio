        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h3
                  className={`text-xl font-semibold ${darkMode ? "text-gray-100" : "text-slate-800"} mb-2`}
                >
                  Background
                </h3>
                <p
                  className={`${darkMode ? "text-gray-400" : "text-slate-600"} leading-relaxed`}
                >
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <p
                  className={`${darkMode ? "text-gray-400" : "text-slate-600"} leading-relaxed`}
                >
                  Enthusiastic about web development, UI/UX design, and building
                  applications that make a positive impact. Love exploring new
                  frameworks and staying updated with industry trends.
                </p>
              </div>
            </div>
          ...
          <div
            className="relative w-full aspect-[16/9] max-w-4xl mx-auto"
